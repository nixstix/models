...
knitr::opts_knit$set(root.dir = '/mnt/BioAdHoc/Groups/Peters/nthrupp/CMI-PB3/MOFA_6assays_TP0and1_factorsOnly_split2/MOFA')
...
### subset for only TP0 and TP1

```{r}
sample_idx = train_data$meta[train_data$meta$Meta.timepoint %in% c(0,1) , 'Meta.specimen_id'] 
length(sample_idx)
