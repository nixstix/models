...
features = c( 'Day0.Meta.age', 'Day0.TcellActivation.PT', 'Day0.TcellPol.pol')
...
save(model1, model2, model3, models, models_alpha, file='../data/regression_models/regression_models_IgG_PT_2.RData')
