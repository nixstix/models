...
f= grep('Day0.Expr', colnames(predictors.baseline), value=T)
...
to_test = to_test[grep('Day0', names(to_test))]
...
save(model1, model2, model3, models, models_alpha, file='../data/regression_models/regression_models_TcellPol2.RData')
