...
```{r, setup}
knitr::opts_knit$set(root.dir = '/mnt/BioAdHoc/Groups/Peters/nthrupp/CMI-PB3/WGCNA_first_pass_TP3_rmPHA_6assays_split2/MOFA')
nr_factors = 15
...
### subset for only TP0 and TP30

```{r}
sample_idx = train_data$meta[train_data$meta$Meta.timepoint %in% c(0,3) , 'Meta.specimen_id'] 
length(sample_idx)
